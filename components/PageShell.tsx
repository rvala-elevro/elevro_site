    ...
    <main className="min-h-screen bg-primary text-cream">
      <section className="relative overflow-hidden px-4 py-24 md:px-8">
        ...
        <div className="relative mx-auto max-w-5xl">
          <Link
            href="/"
            className="mb-10 inline-flex items-center gap-2 rounded-full border border-white/10 px-4 py-2 text-sm text-cream/70 transition hover:bg-white/10 hover:text-white"
          >
          ...
          <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.055] p-8 shadow-card backdrop-blur-xl md:p-14">
            ...
            <Link
              href="/contact-us"
              className="mt-9 inline-flex items-center gap-2 rounded-full bg-secondary px-7 py-4 font-medium text-white shadow-glow transition hover:scale-105"
            >
